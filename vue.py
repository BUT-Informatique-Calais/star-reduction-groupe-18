...
class Vue(QMainWindow) :
    ...
    def __init__(self) :
        ...
        actionEnregistrerImages = QAction("Enregistrer toutes les images", self)
        ...
        # -- Fichier
        menuFichier.addAction(actionChargerFichier)
        menuFichier.addAction(actionEnregistrerImages)
        ...
        actionEnregistrerImages.triggered.connect(self.enregistrerImages)
...
if __name__ == "__main__":
    ...
    a : Modele = Modele('./examples/test_M31_linear.fits')
    fenetre = Vue()
    sys.exit(app.exec())